...
# SCPN Dense Plasma Focus Core — portable diagnostic-plan envelope
...
PROJECT: Final = "SCPN-DENSE-PLASMA-FOCUS-CORE"
...
class PlanEnvelope:
    ...
    binding
        ...
        embedded :data:`~scpn_dense_plasma_focus_core.observability.CATALOGUE_BINDING`.
    plan_identifier
