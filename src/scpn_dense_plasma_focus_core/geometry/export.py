...
# SCPN Dense Plasma Focus Core — open-format mesh exports
...
digests, the model digest, the pinch column, the segment count, the
...
from scpn_dense_plasma_focus_core.geometry.cad import DeviceModelCAD
from scpn_dense_plasma_focus_core.geometry.model import DeviceModel3D
...
def write_step(path: Path, model: DeviceModelCAD) -> int:
    ...
    normalised deterministic header (ADR 0009).
