...
# SCPN Dense Plasma Focus Core — repository-level truth tests
...
REQUIRED_PATHS = (
    ...
    "src/scpn_dense_plasma_focus_core/__init__.py",
    "src/scpn_dense_plasma_focus_core/configuration.py",
    "src/scpn_dense_plasma_focus_core/errors.py",
    "src/scpn_dense_plasma_focus_core/observability.py",
    "src/scpn_dense_plasma_focus_core/plan_envelope.py",
    "tests/data/plan_envelope_fixture.json",
    "src/scpn_dense_plasma_focus_core/parameters.py",
    ...
    "src/scpn_dense_plasma_focus_core/physics/radial.py",
    "src/scpn_dense_plasma_focus_core/physics/pinch.py",
    "src/scpn_dense_plasma_focus_core/physics/beam.py",
    "src/scpn_dense_plasma_focus_core/physics/neutron.py",
    "src/scpn_dense_plasma_focus_core/physics/level0.py",
...
def test_manifest_declares_exact_configuration_assignment() -> None:
    ...
    assert manifest["project"] == "SCPN-DENSE-PLASMA-FOCUS-CORE"
...
def test_package_agrees_with_manifest_truth() -> None:
    ...
    from scpn_dense_plasma_focus_core import OWNED_CONFIGURATIONS, RegistryBinding
