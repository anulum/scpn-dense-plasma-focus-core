...
# SCPN Dense Plasma Focus Core — transformations diagnostic tests
...
from scpn_dense_plasma_focus_core.observability import TransformationKind
...
def test_transformation_rejects_self_mapping() -> None:
    ...
    with pytest.raises(DiagnosticPlanError, match="to itself"):
        frame_transformation(target_identifier="frm_electrode_axis")
