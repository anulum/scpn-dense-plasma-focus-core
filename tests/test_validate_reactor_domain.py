...
# SCPN Dense Plasma Focus Core — reactor-domain validator tests
...
def test_map_cross_check_rejects_assignment_and_pin_drift(tmp_path: Path) -> None:
    ...
    map_path.write_text(
        json.dumps(
            {
                "planned_repositories": ["SCPN-DENSE-PLASMA-FOCUS-CORE"],
                "existing_repositories": [],
                "configuration_assignments": {
                    "conventional_tokamak": "SCPN-DENSE-PLASMA-FOCUS-CORE"
                },
