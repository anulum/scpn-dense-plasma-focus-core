...
//! Vendored `ln`, `exp` and real power (byte-identical in every operation to
//! `rust/src/numerics/transcendental.rs` of SCPN-REACTOR-KERNELS at commit
//! `799d44d3`, the canonical copy, retired once the library is pinned) mirroring
//! `scpn_dense_plasma_focus_core.physics._transcendental` operation for operation:
